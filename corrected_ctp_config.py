...
def corrected_ctp_connection(config: Dict[str, Any]):
    """使用正确键名的CTP连接"""
    print(f"\n正在连接CTP服务器...")
...
def main():
    ...
    config = {
        ...
        "密码": password,
        "经纪商代码": "9999",
        "交易服务器": "tcp://182.254.243.31:40001",  # SimNow模拟交易地址
        "行情服务器": "tcp://182.254.243.31:40011",  # SimNow行情地址
        "产品名称": "CTP_SIMNOW",
        "授权编码": "0000000000000000",  # 使用正确的键名
        "应用ID": "simnow_client_test"
    }
    
    # 执行连接
    result = corrected_ctp_connection(config)
