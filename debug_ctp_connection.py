...
def debug_ctp_connection(config: Dict[str, Any]):
    """调试CTP连接"""
    print(f"\n正在连接CTP服务器...")
...
def main():
    ...
    config = {
        ...
        "product_info": "CTP_SIMNOW",
        "auth_code": "0000000000000000",  # SimNow认证码
        "app_id": "simnow_client_test"
    }
    
    # 执行调试连接
    debug_ctp_connection(config)
